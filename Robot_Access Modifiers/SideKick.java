...
public class SideKick {
    ...
    /** TODO 1 Solution: Make property modeOfOperation protected from outside access
     *                   is implemented by making the property "private"
     **/
    /**
    ...
    /** TODO 7 Solution: Implement a setter for "modeOfOperation" using Java convention   **/
    public void setModeOfOperation(int modeOfOperation) 
    {
        /** TODO 8 Solution: In the setter method you created in TODO 7 put in a condition
         *          to ensure that if the value being passed is not between 1 and 3
         *          then set it to the default of 1 - which represents cleaning.
         *          We do this by puttin an if-else
         **/
     ...
     public void takeAction() {
        switch (modeOfOperation) {
            case 1:
                ...
                break;
            case 2:
                /** TODO 14 Solution: call the method cookFood() you created in TODO 13  **/
                cookFood();
    ...
    /** TODO 11 Solution: The method cleanHouse() will only be used internally.
     *           Protect it with "private". "public" is commented out but
     *           you may remove it altogether.
     **/
     // method to clean
    ...
    // method to cook
    /** TODO 13 Solution: Create a method to display the tasks SideKick does
